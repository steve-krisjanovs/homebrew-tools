...
class ToneaiNux < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/steve-krisjanovs/toneai-nux-imprint/releases/download/v1.4.1/toneai-nux-mac-arm64"
      sha256 "2bf92f4313359ea9a2145ef473184c8115fe4b1b6a7d1e70d0654fd616fff0c1"
    end
    on_intel do
      url "https://github.com/steve-krisjanovs/toneai-nux-imprint/releases/download/v1.4.1/toneai-nux-mac-x64"
